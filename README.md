...
1. download the theme file, [`Cyberpunk.theme.css`](https://github.com/Warzob/MidnightFlavor/blob/main/themes/midnightmountain-blue.theme.css). (there should be a download button at the top right of the page)
